...
Gem::Specification.new do |spec|
  ...
  spec.description = "A Ruby gem that converts timestamps into fuzzy, human-friendly relative time strings like 'less than a minute ago', 'about 2 months ago', etc."
